      ...
      <>
        <div className="sm:sticky sm:top-0  w-full ">
          <figure className="w-full h-screen flex items-center justify-center ">
            <img
              src={'/img/nature/grasses-7304572_1920.jpg'}
        ...
        <div className="sm:sticky sm:top-2  w-full ">
          <figure className="w-full h-screen flex items-center justify-center ">
            <img
              src={'/img/nature/jingle-bells-9924928_1920.jpg'}
        ...
        <div className="sm:sticky sm:top-4  w-full ">
          <figure className="w-full h-screen flex items-center justify-center ">
            <img
              src={'/img/nature/pexels-ankit-rainloure-1425442-29876830.jpg'}
        ...
        <div className="sm:sticky sm:top-6  w-full ">
          <figure className="w-full h-screen flex items-center justify-center ">
            <img
              src={'/img/nature/pexels-chiaroscuro-154214185-10601420.jpg'}
        ...
        <div className="sm:sticky sm:top-8  w-full ">
          <figure className="w-full h-screen flex items-center justify-center ">
            <img
              src={'/img/nature/pexels-farisi-2158123179-35290807.jpg'}
        ...
        <div className="sm:sticky sm:top-12  w-full ">
          <figure className="w-full h-screen flex items-center justify-center ">
            <img
              src={'/img/nature/pexels-pixabay-35196.jpg'}
