    ...
    <section className="w-full h-screen flex items-center border-b-[1px] border-b-black">
      <div className="container mx-auto flex items-center gap-8">
        ...
        <div className="w-1/2 flex justify-center items-center">
          <img loading="lazy" decoding="async" src="img/nature/pexels-pixabay-35196.webp" alt="Dew drops on leaf" className="max-w-full h-auto shadow-lg max-h-96 object-contain" />
        </div>
      </div>
    </section>
  )
