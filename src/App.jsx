...
const Layout = () => {
  ...
  return (
    <div className="font-bodyFont no-select">
      <Header />
      <ScrollRestoration />
      <Suspense fallback={<div className="w-full h-screen bg-[#080808] flex items-center justify-center"><span className="font-lemonMilk text-xs tracking-widest text-gray-700 uppercase animate-pulse">Loading…</span></div>}>
        {/* pb-16 gives room for the mobile bottom nav bar */}
