...
import { poster2Designs } from "../constants/designProjects";
...
const MenuCard = () => {
    ...
    return (
        <div className="max-w-container mx-auto px-4">
            <Breadcrumbs title="Menu Card Designs" prevLocation={prevLocation} />

            <div className="pb-20">
                <h1 className="text-3xl font-bold text-primeColor mb-2">Menu Card Designs</h1>
                <p className="text-base text-lightText mb-10">
                    Creative menu card designs crafted for restaurants, cafes, and events with a focus on visual appeal and readability.
                </p>
