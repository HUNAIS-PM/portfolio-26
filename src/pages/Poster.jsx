...
import { posterDesigns } from "../constants/designProjects";
...
const Poster = () => {
    ...
    return (
        <div className="max-w-container mx-auto px-4">
            <Breadcrumbs title="Poster Designs" prevLocation={prevLocation} />

            <div className="pb-20">
                <h1 className="text-3xl font-bold text-primeColor mb-2">Poster Designs</h1>
                <p className="text-base text-lightText mb-10">
                    A showcase of all my poster design work — from event promotions to creative branding campaigns.
                </p>
